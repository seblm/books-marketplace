...
public class Erreur extends Protocole {
    ...
    public String toString() {
        return toStringHelper(this).add("nom", this.nom)
                .add("message", message).add("pdmnom", pdmnom)
                .add("adresse", adresse).add("raison", raison).toString();
    }

    @Override
    public boolean equals(Object obj) {
        if (Erreur.class.isInstance(obj)) {
            final Erreur other = (Erreur) obj;
            return equal(nom, other.nom) && equal(message, other.message)
                    && equal(pdmnom, other.pdmnom)
                    && equal(adresse, other.adresse)
                    && equal(raison, other.raison);
        }
        return false;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hashCode(nom, message, pdmnom, adresse, raison);
    }
