...
public class TypeMessage {
    ...
    private static final String[] message = { "INCONNU", "WELCOME", "RESULTWELCOME", "BYE", "ERREUR",
            "REQUETEPROGRAMME", "RESULTPROPOSEVENTE", "PROPOSEVENTE", "PROPOSITIONENCHEREA", "RESULTAT", "RESULTBYE",
            "WELCOMEAGENT", "PROPOSITIONENCHEREP", "PROPOSITIONENCHERE", "PROGRAMME", "REQUETEAGENTS", "RESULTAGENTS",
            "ADMIN" };

    private int type;

    public TypeMessage(int type) {
        this.type = type;
    }
