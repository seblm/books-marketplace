...
public class ConfigurationBd extends javax.swing.JFrame {
    ...
    private void initComponents() {// GEN-BEGIN:initComponents
        ...
        jPanelConteneur.setBorder(new javax.swing.border.CompoundBorder(new javax.swing.border.EmptyBorder(
                new java.awt.Insets(10, 10, 10, 10)), new javax.swing.border.EtchedBorder()));
        ...
        jPanelSupprimerPdm.setBorder(new javax.swing.border.CompoundBorder(new javax.swing.border.EmptyBorder(
                new java.awt.Insets(10, 10, 0, 10)), new javax.swing.border.EtchedBorder()));
    ...
    private void jButtonSupprimerPdmMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_jButtonSupprimerPdmMouseClicked
        ...
        try {
            ...
            if ((bd.requete("DELETE FROM agents WHERE nomPDM = '" + nomPlaceDeMarche + "'")
                    + bd.requete("DELETE FROM pdms WHERE nom = '" + nomPlaceDeMarche + "'") + bd
                        .requete("DELETE FROM items WHERE Proprio = '" + nomPlaceDeMarche + "'")) == 0) {
    ...
    private void jButtonEnregistrerMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_jButtonEnregistrerMouseClicked
        try {
            Protocole.parametresBd.setParametres(jTextFieldServeur.getText(),
                    Integer.parseInt(jTextFieldPort.getText()), jTextFieldUtilisateur.getText(),
                    String.valueOf(jPasswordFieldMotDePasse.getPassword()), jTextFieldBaseDeDonnees.getText());
