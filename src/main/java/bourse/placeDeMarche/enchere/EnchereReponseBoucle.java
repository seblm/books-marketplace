...
public abstract class EnchereReponseBoucle extends Enchere {
    ...
    protected EnchereReponseBoucle(int numEnchere, Livre livre) {
        super(numEnchere, livre);
    }

    protected EnchereReponseBoucle(int numEnchere, float prixVente, int idLivre) {
        super(numEnchere, prixVente, idLivre);
    }

    protected void decrementerPrixCourant() {
