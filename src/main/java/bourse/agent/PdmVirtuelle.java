            ...
            while (!sortir) {
                ...
                case 2:
                    this.ecrire(new bourse.protocole.Erreur("Duplication",
                            "désolé, t'es dupliqué man.", "localhost", "1981")
                            .toXML());
                    break;
                case 3:
                ...
                case 12:
                    this.ecrire(new Erreur("Zerovente",
                            "désolé, je veux pas vendre ton bouquin de merde.")
                            .toXML());
                    break;
                case 13:
