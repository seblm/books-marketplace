...
public class Ia extends Decision {
    ...
    public void choixAction() {
        ...
        } else if ((new Date().getTime() - pere.getEnvironnement().getDateListeAgent()) > 5000) {
        	// si on a pas téléchargé la liste des agents depuis 5 secondes, on redemande la liste des agents.
            pere.setAction(new Action(5));
        } else if ((new Date().getTime() - pere.getEnvironnement().getDateListeProgramme()) > 5000) {
        	// si on a pas téléchargé la liste des programmes depuis 5 secondes, on redemande la liste des programmes.
            pere.setAction(new Action(4));
