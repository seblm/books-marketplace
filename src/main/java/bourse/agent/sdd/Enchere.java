...
public class Enchere {
    ...
    public int getNumeroEnchere(){return this.numeroEnchere;}
    public Livre getLivre(){return this.livre;}
    public float getValeurEnchere(){return this.valeurEnchere;}
    ...
    public String toString(int decalage) { 
        ...
        return delta + "tour = " + this.numeroEnchere
                   + ", type = " + this.type
                   + ", temps = " + this.temps
                   + ", pas = " + this.pas
    ...
    public static int enchereToCode(String typeEnchere) {
        if (typeEnchere.equalsIgnoreCase("EnchereUn")) return 1;
        else if (typeEnchere.equalsIgnoreCase("EnchereDeux")) return 2;
        else if (typeEnchere.equalsIgnoreCase("EnchereTrois")) return 3;
        else if (typeEnchere.equalsIgnoreCase("EnchereQuatre")) return 4;
