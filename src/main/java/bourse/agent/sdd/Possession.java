...
public class Possession {
    ...
    private Livre livre;
    /** La date de la vente en temps systeme (0 si le livre appartient à une pdm). */
    private long date;
    ...
    public String toString(int decalage) {
        ...
        return delta + "livre = " + "\n" + livre.toString(decalage+1) + "\n"
             + delta + "en instance de vente = " + instanceDeVente + "\n"
    ...
    public static void main(String[] argc) {
        ...
        bourse.sdd.Livre l1 = new bourse.sdd.Livre("l1", "a2", new bourse.protocole.Categorie(), "poche", "O'reilly", (float)50.65, (float)0.45, "2004-01-01", "222222222", 1, "Eric", (float)60);
        bourse.sdd.Livre l2 = new bourse.sdd.Livre("l2", "a1", new bourse.protocole.Categorie(), "poche", "Casterman", (float)40.75, (float)0.85, "1954-04-12", "222XX2254", 2, "protocoleman", (float)200);
        bourse.sdd.Livre l3 = new bourse.sdd.Livre("l2", "a1", new bourse.protocole.Categorie(), "poche", "Casterman", (float)40.75, (float)0.27, "1954-04-12", "222XX2254", 3, "Seb", (float)25.51);
        Possession t1 = new Possession(l1);
        Possession t2 = new Possession(l2);
        Possession t3 = new Possession(l3);
        System.out.println(t1.toString(0)); t1.toRow(tableau, 0);
        System.out.println(t2.toString(5)); t2.toRow(tableau, 1);
        System.out.println(t3.toString(2)); t3.toRow(tableau, 2);
