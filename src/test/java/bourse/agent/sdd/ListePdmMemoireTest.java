...
public class ListePdmMemoireTest {
    ...
    public void initialisation() {
        pdmMemoires = new PdmMemoire[] { new PdmMemoire("p1", "HOME", false, false, new ListeProgramme(), 1),
    ...
    public void testListePdmMemoire() {
        ...
        if (listePdmMemoire.premiereActiveNonVisitee() != null)
            System.out.println("Première active non visitée : "
                    + listePdmMemoire.premiereActiveNonVisitee().toString(4));
